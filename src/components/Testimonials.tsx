...
const TestimonialsSchema = ({ testimonials }: { testimonials: Testimonial[] }) => {
  ...
  const averageRating = testimonials.length > 0 ? Math.round((totalRating / testimonials.length) * 10) / 10 : 5;
  ...
  return (
    <section className="py-8 bg-muted">
      ...
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">What Our Students Say | 学生反馈</h2>
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          Testimonials from students who achieved excellent results
        </p>
              ...
              <CardContent className="pt-6">
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground italic mb-3">"{testimonial.comment}"</p>
                  </div>
                </div>
                ...
                <div className="border-t pt-4">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">{testimonial.grade}</p>
                </div>
              </CardContent>
            </Card>
          ))}
